 ...
 *  Simulação em tempo real do conversor Boost em Malha Fechada
 *  Bolsista: Carlos Eduardo Miranda da Silva
 *  Orientador: Daniel Pagano
 *
...
// ---------- Peripheral settings ----------
void ConfigurePWM(void); // FINALIZADO
void SetupTimer(void); // FINALIZADO
...
/* interrupt void Calibration(void); */
