...
void ConfigureADC(void); // In progress

// ---------- Interrupt Routines ----------
interrupt void Time(void); // In progress
...
void ConfigurePWM(void){
    ...
    InitEPwm(); /* Must verify wether this function will be necessary */
    InitEPwm1Gpio();
}
...
void ConfigureADC(){
    ...
    InitADC(); /* Must verify wether this function will be necessary */
